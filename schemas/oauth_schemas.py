...
class ValidateTokenResponse(BaseResponse):
    ...
    expires_at: int | None = Field(None, description="Token expiration timestamp if valid")
...
class AuthorizationUrlResponse(BaseResponse):
    ...
    state: str | None = Field(None, description="State parameter for security")
...
class OAuthCallbackRequest(BaseModel):
    ...
    state: str | None = Field(None, description="State parameter from authorization request")
    error: str | None = Field(None, description="Error from OAuth provider")
    error_description: str | None = Field(None, description="Error description from OAuth provider")
