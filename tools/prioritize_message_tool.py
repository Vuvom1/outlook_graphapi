...
class PrioritizeEmailTool(Tool):
    ...
    def _update_email_priority(self, access_token: str, email_id: str, priority_level: str):
        ...
        try:
            ...
            update_data = {"importance": priority_level}
            ...
            get_response = requests.get(
                f"{url}?$select=id,subject,importance,sender,receivedDateTime", headers=headers, timeout=30
            )
...
prioritize_email_tool = PrioritizeEmailTool(
    runtime=None,
    session=None,
)
