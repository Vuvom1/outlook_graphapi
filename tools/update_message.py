...
class UpdateMessageTool(Tool):
    ...
    def _update_email_message(self, access_token: str, email_id: str, subject: str, body_content: str, body_type: str):
        """
        ...
        try:
            ...
            data = {"subject": subject, "body": {"contentType": body_type, "content": body_content}}
