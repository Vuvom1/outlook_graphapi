    ...
    def _create_draft_email(
        ...
        try:
            ...
            message = {
                ...
                "body": {"contentType": "html" if body_type.lower() == "html" else "text", "content": body_content},
            ...
            result = {
                ...
                "body_preview": draft_data.get("bodyPreview", "")[:200] + "..."
                if len(draft_data.get("bodyPreview", "")) > 200
                else draft_data.get("bodyPreview", ""),
    ...
    def _parse_recipients(self, recipients_str: str) -> list[dict]:
        ...
        for email in email_list:
            ...
            if "<" in email and ">" in email:
                ...
                recipients.append({"emailAddress": {"address": email_part, "name": name_part}})
            else:
                # Just email address
                recipients.append({"emailAddress": {"address": email, "name": email}})
...
draft_message_tool = DraftEmailTool(runtime=None, session=None)
