...
class AddAttachmentToDraftTool(Tool):
            ...
            try:
                ...
                for file_obj in files_to_attach:
                    ...
                    result = self._add_attachment_to_draft(
                        access_token, draft_id, file_data, attachment_name or file_data.get("name", "attachment")
                    )
    ...
    def _add_attachment_to_draft(self, access_token: str, draft_id: str, file_data: dict, attachment_name: str):
        """
...
add_attachment_to_draft_tool = AddAttachmentToDraftTool(
